...
def main():
    ...
    opt_gpr_feature_num = 47
    hcp_gpr_features = hcp_gpr_feat_list[:opt_gpr_feature_num]
    hcp_gpr_features.append('Age')
    hcp_gpr_features.append('Subject')

    subject_data = subject_data.loc[:, hcp_gpr_features]
    #####################################################################################################
    # K-FOLD
    #####################################################################################################
    # 데이터 셋을 변경하는 경우 이 부분 변경 필요 
