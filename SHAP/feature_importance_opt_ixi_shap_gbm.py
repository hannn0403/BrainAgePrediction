...
def main():
    ...
    ixi_gbm_features = ixi_gbm_feat_list[:opt_gbm_feature_num]
    ixi_gbm_features.append('Age')
    ixi_gbm_features.append('Subject')
 
    subject_data = subject_data.loc[:, ixi_gbm_features]
    #####################################################################################################
    # K-FOLD
    #####################################################################################################
    # 데이터 셋을 변경하는 경우 이 부분 변경 필요
